...
export const zhenlongGuide: AuthenticityGuide = {
  ...
  packagingVerification: [
    ...
    { item: '龙纹', genuineFeature: '清晰', fakeFeature: '模糊', importance: 'high' },
  ],
