  ...
  useTranslation: () => ({
    ...
    t: (key: string) => {
      const translations: Record<string, string> = {
        "productBrowser.searchPlaceholder": "Search products...",
        "productBrowser.region.all": "All",
        "productBrowser.region.mainland": "Mainland",
        "productBrowser.region.hkmo": "Hong Kong & Macau",
        "productBrowser.region.international": "Imported",
        "productBrowser.format.all": "Format",
        "productBrowser.format.hard": "Hard",
        "productBrowser.format.slim": "Slim",
        "productBrowser.sort.newest": "Newest",
        "productBrowser.sort.priceAsc": "Price Low to High",
        "productBrowser.sort.priceDesc": "Price High to Low",
        "productBrowser.sort.name": "Name",
        "productBrowser.results": "Results",
        "productBrowser.empty": "No matching products",
      };
    ...
    default: ({ products }: { products: Array<{ id: number; name: string }> }) => (
      <div data-testid="product-grid">
        {products.map((product) => (
          <div key={product.sku_id} data-testid={`product-${product.sku_id}`}>
            {product.name}
          </div>
        ))}
      </div>
