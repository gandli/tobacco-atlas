...
const HeroSection = () => {
  ...
  return (
    <>
      <div className="relative flex flex-col items-center justify-center min-h-[80vh] md:min-h-screen px-4 md:px-6 text-center">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm text-muted-foreground border border-border rounded-full hover:bg-secondary transition-colors"
          >
      ...
      <WhyThisExistsDialog open={whyThisExistsOpen} onOpenChange={setWhyThisExistsOpen} />
    </>
  );
};
